// chromatic_aberration.wgsl — post-process shader for forgia-pp-chromatic-aberration.
...
fn fragment(in: FullscreenVertexOutput) -> @location(0) vec4<f32> {
    ...
    // TODO: implement chromatic-aberration effect. Currently passthrough * strength.
