// fog.wgsl — post-process shader for forgia-pp-fog.
...
@group(0) @binding(2) var<uniform> settings: FogSettings;

@fragment
fn fragment(in: FullscreenVertexOutput) -> @location(0) vec4<f32> {
    let color = textureSample(screen_texture, texture_sampler, in.uv);
    // TODO: implement fog effect. Currently passthrough * strength.
